...
# export HBASE_OPTS
#export HBASE_OPTS="$HBASE_OPTS -javaagent:/home/vagrant/prometheus/jmx_prometheus_javaagent-0.16.1.jar=7000:/home/vagrant/prometheus/hbase_jmx_config.yaml"
